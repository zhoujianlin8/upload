...
(function (global) {
    ...
    function newContext(contextName) {
        ...
        context = {
             ...
             */
            completeLoad: function (moduleName) {$(document).trigger('loader-complete', [moduleName]);///向外抛出完成事件
                var found, args, mod,
...
jQuery.event = {
	...
	handlers: function( event, handlers ) {
		...
		if ( delegateCount && cur.nodeType && ((event.button==0||event.button==1) || event.type !== "click") ) {///鼠标左键的标准不一样
